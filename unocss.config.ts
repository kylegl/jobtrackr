...
export default defineConfig({
  shortcuts: {
    ...
    'btn-hover': 'hover:shadow-sm hover:op100 in_out',
    'btn-active': 'op100',
    ...
    'btn-toggle': 'op70',
    'btn-inactive': 'op40',
    'btn-group-hover': 'op70 group-hover:op100 in_out',
    ...
    'click-heading': 'op70 hover:op100 in_out',
    ...
    'heading': 'op70',
    'shadow-hover': 'shadow-md hover:shadow-sm in_out',
    't1': 'text-base',
